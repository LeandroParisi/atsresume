const DefaultResumeData = {
  ...
  workExperience: [

    {
      ...
      with infrastructure. Main Contributions:`,
      "keyAchievements": `Implemented and restructure code base applying best practices and increasing code quality.
    ...
    },
    {
      ...
      "description": "Vrolio provides the highest standard, investment-grade short-term rental\ndata that powers the investment decisions of thousands of STR investors\nand agents across the US. Main Contributions:",
      "keyAchievements": `Created and implemented architecture of back end using concepts of Distributed system and queuing thus increasing it's performance by an average of 50% and allowing for huge data ingestion
    ...
    },
    {
      ...
      "description": "Metrobi aims to support local food and beverage makers with logistics, financial, and marketing tools and help them expand their distribution businesses. Main Contributions: ",
      "keyAchievements": `Lead a team of 4 people, reorganizing team and rituals thus increasing productivity by 20%
      Restructured front end app applying a consistent architecture pattern for junior developers to follow.
      About the main contributions above I can highlight:
      As a leader I was responsible for: Teaching and mentoring junior developers; Apply and lead all relevant scrum rituals.
      The 20% productivity boost was achieved by applying all the scrum rituals (which were not being used before I entered the team); implementing a proper and organized Q&A pipeline in order to reduce the number of times a task would be moved from 'testing' into 'development' stage; Creating a proper and organized bug report system with a Jira board created with specific automations and trigger where the ops team could report their bugs to the dev team in a structured way and we (dev team) had a strict method to prioritize and tackle each bug.
      About the architecture patterns applied: The code base was overall pretty disorganized, there was no patterns for building components, stores, etc. which were applied consistently. This caused each component / store to be created in a different way, thus increasing the overhead for new members and even current members of the team everytime they stumbled upon a different pattern in the code. I have standardized many of these elements and have created documentations to encourage the team to follow those patterns.
